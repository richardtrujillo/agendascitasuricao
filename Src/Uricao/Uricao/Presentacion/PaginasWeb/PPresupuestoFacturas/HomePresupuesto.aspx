...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        <table align= "center">
            <tr>
                <td> 
                    <asp:Button class = "button" id = "aBAgregar_Presupuesto" runat = "server" Text = "Generar" Width = "133px"> 
                    </asp:Button> 
                    <!--esta es la creacion del buton, en el class va el nombre del style que se encuentra
                    en Site.css -->
                </td>
                <td>
                    <asp:Button class = "button" id = "aBConsultar_Presupuesto" runat = "server" Text = "Consultar" Width = "133px"> 
                    </asp:Button> 
                </td>
